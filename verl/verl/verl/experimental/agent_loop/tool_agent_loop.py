...
from verl.experimental.agent_loop.tool_parser import FunctionCall, ToolParser, MultiModalCodeToolParser
...
class ToolAgentLoop(AgentLoopBase):
    ...
    async def run(self, sampling_params: dict[str, Any], **kwargs) -> AgentLoopOutput:
        ...
        logging.info("***This is ToolAgentLoop***\n"*30)
    ...
    async def _handle_generating_state(
        ...
        # Extract tool calls
        _, agent_data.tool_calls = await self.tool_parser.extract_tool_calls(responses_ids=agent_data.response_ids)
